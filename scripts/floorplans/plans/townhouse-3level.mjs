...
export function build() {
  ...
  const groundFurn = [
    ...
    furn('desk', 1200, 10400, { rotation: 0 }),
  ...
  const middleFurn = [
    ...
    furn('tv_stand', 300, 2000, { rotation: 270 }),
    furn('tv', 300, 2000, { rotation: 270, localState: 'off' }),
    furn('chair', 4000, 2200, { rotation: 90, label: 'Armchair' }),
    furn('rug', 2600, 1600, { rotation: 0, w: 3400, h: 2400 }),
    furn('chair', 300, 4800, { rotation: 270, label: 'Reading chair' }),
    ...
    furn('microwave', 900, 10700, { rotation: 0, elevation: 1400 }),
    furn('dishwasher', 2050, 10700, { rotation: 0 }),
    furn('kitchen_sink', 2800, 10700, { rotation: 0 }),
    furn('counter', 1500, 10700, { rotation: 0, w: 2000, h: 600 }),
    furn('counter', 4000, 10700, { rotation: 0, w: 1600, h: 600 }),
  ...
  const topFurn = [
    ...
    furn('wardrobe', 5000, 6800, { rotation: 180, w: 1200, h: 600 }),
    furn('wardrobe', 5600, 7900, { rotation: 90, w: 1200, h: 600 }),
    // Primary ensuite
