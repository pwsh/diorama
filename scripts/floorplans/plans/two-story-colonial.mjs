...
export function build() {
  ...
  const doors1 = [
    ...
    door(9000, 5700, 0, { w: 800, label: 'Mudroom' }),
    ...
    door(17500, 6100, 0, { w: 900, label: 'Garage man-door' }),
  ];
  ...
  const furniture1 = [
    ...
    // Foyer
    furn('bench', 4850, 700, { rotation: 90 }),
    ...
    furn('cabinet', 7550, 1200, { rotation: 90, label: 'China cabinet' }),
    furn('rug', 9775, 2150, { rotation: 0, w: 2700, h: 1900 }),
    furn('plant', 11950, 3950, { rotation: 0 }),
    // Half Bath
    furn('toilet', 7550, 4500, { rotation: 90 }),
    furn('sink', 8650, 5500, { rotation: 180, label: 'Vanity' }),
    // Mudroom / Laundry
    furn('washer', 11700, 4500, { rotation: 0 }),
    furn('dryer', 12050, 4500, { rotation: 0 }),
    furn('bench', 9300, 4500, { rotation: 0 }),
    ...
    furn('counter', 7550, 6900, { rotation: 90, w: 600, h: 2000 }),
    furn('counter', 8700, 5900, { rotation: 0, w: 2200, h: 650 }),
    furn('stove', 8900, 5900, { rotation: 0 }),
    furn('microwave', 8400, 6000, { rotation: 0, elevation: 1400 }),
    furn('dishwasher', 9300, 5900, { rotation: 0 }),
    furn('kitchen_sink', 8600, 9700, { rotation: 180 }),
    furn('island', 9000, 7800, { rotation: 0 }),
    furn('fridge', 7550, 9300, { rotation: 90 }),
    furn('cabinet', 7550, 8200, { rotation: 90 }),
    // Breakfast Nook (east zone of the open room)
    furn('table', 11100, 8000, { rotation: 0, w: 900, h: 900, label: 'Breakfast' }),
    furn('chair', 10600, 7600, { rotation: 90 }),
    furn('chair', 11600, 7600, { rotation: 90 }),
    furn('chair', 10600, 8400, { rotation: 270 }),
    furn('chair', 11600, 8400, { rotation: 270 }),
    furn('plant', 11900, 6200, { rotation: 0 }),
    // Garage
    furn('cabinet', 17900, 900, { rotation: 270 }),
    furn('desk', 12400, 3000, { rotation: 90, label: 'Workbench' }),
    furn('bookshelf', 17900, 5300, { rotation: 270, label: 'Shelving' }),
    // Side-yard dressing (unbuilt notch beside the garage — bare ground)
    furn('trash_bin', 13000, 7000, { rotation: 0 }),
    furn('recycle_bin', 13700, 7000, { rotation: 0 }),
  ...
  const doors2 = [
    ...
    door(9950, 4700, 270, { w: 700, label: 'Linen' }),
  ...
  const furniture2 = [
    ...
    furn('bookshelf', 4850, 1800, { rotation: 90 }),
    furn('rug', 6000, 1200, { rotation: 0, w: 1200, h: 2000 }),
    // Upstairs Hallway
    furn('bookshelf', 4850, 9600, { rotation: 0 }),
    furn('rug', 6000, 8000, { rotation: 0, w: 1200, h: 2400 }),
    ...
    // Hall Bath
    furn('toilet', 7550, 4500, { rotation: 90 }),
    furn('sink', 9600, 5500, { rotation: 180, label: 'Vanity' }),
    furn('bathtub', 8600, 5500, { rotation: 180, w: 1700, h: 750 }),
    // Linen / Storage
    furn('cabinet', 11100, 5000, { rotation: 0, label: 'Linen' }),
    // Primary Bathroom
    furn('toilet', 400, 4500, { rotation: 90 }),
    furn('sink', 300, 5300, { rotation: 90, label: 'Vanity' }),
    furn('bathtub', 1900, 4500, { rotation: 0, w: 1600, h: 750 }),
    furn('shower', 2300, 5400, { rotation: 270, w: 800, h: 800 }),
    // Primary Walk-in Closet
    furn('wardrobe', 2850, 5000, { rotation: 90 }),
    furn('wardrobe', 4450, 5000, { rotation: 270 }),
    furn('dresser', 3650, 4450, { rotation: 0 }),
    // Primary Bedroom
    ...
    furn('nightstand', 7700, 8700, { rotation: 0 }),
    furn('nightstand', 9700, 8700, { rotation: 0 }),
    furn('dresser', 11700, 6300, { rotation: 90 }),
