...
export function buildRanchBones(b) {
  ...
  const doors = [
    ...
    door(2600, 8300, 0, { w: 700, label: 'Primary WIC' }),
    door(4500, 6500, 270, { w: 700, label: 'Hall Bath' }),
    door(4500, 8700, 270, { w: 900, label: 'Office' }),
    door(9200, 3800, 0, { w: 900, label: 'Living ↔ Kitchen' }),
  ...
  const furniture = [
    ...
    furn('coffee_table', 5650, 300, { rotation: 180, label: 'Console' }),
    furn('plant', 7500, 300, { rotation: 0 }),
    // Bedroom 2
    ...
    furn('wardrobe', 2100, 9150, { rotation: 90 }),
    furn('wardrobe', 3300, 9150, { rotation: 270 }),
    // Hall Bath
    ...
    furn('bookshelf', 4700, 8900, { rotation: 90 }),
    // Kitchen
    ...
    // Dining
    furn('table', 12800, 5400, { rotation: 0, label: 'Dining table' }),
    furn('chair', 12800, 4700, { rotation: 0 }),
    furn('chair', 12800, 6100, { rotation: 180 }),
    furn('chair', 11900, 5100, { rotation: 90 }),
    furn('chair', 11900, 5700, { rotation: 90 }),
    furn('chair', 13700, 5100, { rotation: 270 }),
    furn('chair', 13700, 5700, { rotation: 270 }),
    furn('cabinet', 14100, 4200, { rotation: 270, label: 'Buffet' }),
    furn('rug', 12800, 5400, { rotation: 0, w: 2700, h: 2100 }),
    ...
    // Garage
    furn('cabinet', 21600, 1000, { rotation: 270 }),
    ...
    furn('trash_bin', 17500, -600, { rotation: 0 }),
    furn('recycle_bin', 18200, -600, { rotation: 0 }),
