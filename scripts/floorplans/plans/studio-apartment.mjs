...
export function build() {
  ...
  const walls = [
    ...
    wall([{ x: 2800, y: 800 }, { x: 3700, y: 800 }]),       // F: utility north
    wall([{ x: 3700, y: 0 }, { x: 3700, y: 800 }]),         // G: utility east
  ];

  const rooms = [
    room('Entry Closet', 450, 350),
    room('Bathroom', 1850, 1200),
    room('Utility Closet', 3250, 400),
  ...
  const doors = [
    ...
    door(2950, 800, 0, { w: 700, label: 'Utility' }),                      // wall F
  ];
  ...
  const furniture = [
    // Bathroom
    furn('bathtub', 2400, 1200, { rotation: 270 }),
    furn('toilet', 1150, 2050, { rotation: 180 }),
    furn('sink', 1150, 700, { rotation: 90, label: 'Vanity' }),
    ...
    furn('stove', 325, 1200, { rotation: 90 }),
    furn('microwave', 325, 1200, { rotation: 90, elevation: 1400 }),
    furn('dishwasher', 300, 2000, { rotation: 90 }),
    furn('kitchen_sink', 325, 2450, { rotation: 90 }),
    furn('counter', 325, 1750, { rotation: 90, w: 600, h: 650 }),
    furn('counter', 325, 3100, { rotation: 90, w: 1200, h: 650 }),
    furn('fridge', 375, 3900, { rotation: 90 }),
    ...
    furn('dresser', 300, 4900, { rotation: 90, w: 1200, h: 550 }),
    furn('wardrobe', 300, 5900, { rotation: 90, w: 1000, h: 600 }),
    // Living area (entry pocket + extension)
    furn('rug', 5300, 1600, { rotation: 0, w: 2600, h: 2200 }),
    furn('sofa', 5000, 1500, { rotation: 90, w: 2000, h: 850 }),
    furn('coffee_table', 5800, 1500, { rotation: 0 }),
    furn('tv_stand', 6450, 1500, { rotation: 270 }),
    furn('tv', 6450, 1500, { rotation: 270, localState: 'off' }),
    furn('bookshelf', 3800, 2200, { rotation: 90 }),
  ];
  ...
  const lights = [
    ...
    light(4700, 900, { iconKind: 'lamp', label: 'Floor lamp', height: 1500 }),
  ];
  ...
  return assembleStore({
    ...
    notes: [
      ...
      '    dresser and a wardrobe along the west wall.',
