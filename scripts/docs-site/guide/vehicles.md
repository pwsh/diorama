...
Ground models have their own [model gallery page](../models/vehicle-models.html)
with a turntable of every one of them.
...
| Ground Vehicles ▸ Fiction | 7 | Placeable | **No — opt in** |
...
- **Ground ▸ Fiction** — seven famous silhouettes, generically described.

### Towing the banner

The aircraft and space packs have no ground footprint — they fly. Their home is
