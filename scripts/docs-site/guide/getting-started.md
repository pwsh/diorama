...
3. **Add rooms.** Drop a room anchor inside a closed wall loop and give it a name. Room names drive contextual behavior — a room named "kitchen" gates snack and coffee thought bubbles, and a room's TV scopes what a seated figure watches.
