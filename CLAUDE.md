...
share. Deliberate trade: flights do NOT raise `controls.maxDistance` (a transient overflight must
...
suite), `flights-render-test.html` (`FLIGHTSRENDER PASS 288/288` — heading/pitch signs asserted
...
(`FLIGHTSUI 172/172` — settings round-trips, flight modal matrix, 2D hit routing; alert-center
67/67 stays green).
