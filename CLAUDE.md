...
`collapsed` class → `.section.collapsed { padding 3px; border-bottom none }` tightens the
collapsed-pill rhythm 25 px → 6 px (clears the emboss shadow's ~4.5 px reach; expanded keeps
the full 12 px + divider); the mmWave section title is "mmWave Sensors" (the "on this floor"
