...
- **`_keyWeather`** gained `effPreset:moonPhase:skyBackdrop` (`skyBucket`) so the sky
  ...
  (34/34 — sun position recomputed, moon phase pixel-sampled, dome colors differ day/night/
