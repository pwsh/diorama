  ...
  avatars: [
    ...
    { id: 'tv-i-love-lucy/lucy-comedienne', label: 'Comedienne (upswept red hair, red dress)',
      ...
      accessories: [
        ...
        { shape: 'box', size: [60, 26, 8], anchor: 'neck', pos: [-24, 2, -16], rot: [0, 0, 0.5], color: 0xffffff },
        { shape: 'box', size: [60, 26, 8], anchor: 'neck', pos: [24, 2, -16], rot: [0, 0, -0.5], color: 0xffffff },
    ...
    { id: 'tv-i-love-lucy/ricky-bandleader', label: 'Bandleader (white dinner jacket, conga)',
      ...
      accessories: [
        ...
        { shape: 'box', size: [48, 18, 12], anchor: 'neck', pos: [0, 8, -16], color: 0x101010 },
    ...
    { id: 'tv-i-love-lucy/fred-landlord', label: 'Landlord (bald, brown cardigan)',
      ...
      accessories: [
        { shape: 'box', size: [70, 22, 6], anchor: 'neck', pos: [0, 4, -16], color: 0xf2efe6 },
