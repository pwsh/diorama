...
const pack: AvatarPackDef = {
  id: 'tv-money-heist', version: 3, label: 'Money Heist',
  ...
  avatars: [
    ...
    { id: 'tv-money-heist/heist-mastermind', label: 'Mastermind (grey suit, round glasses)',
      ...
      accessories: [
        ...
        { shape: 'cape', size: [240, 255, 350], anchor: 'back', pos: [0, -90, 30], rot: [0.12, 0, 0], color: 0x505050, animate: { kind: 'sway', speed: 0.6, amp: 0.15 } }, // overcoat drape
      ],
