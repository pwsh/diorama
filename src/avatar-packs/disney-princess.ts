  ...
  avatars: [
    ...
    { id: 'disney-princess/the-mermaid', label: 'The Mermaid (land variant, teal skirt)', rig: 'humanoid',
      ...
      accessories: [
        ...
        { shape: 'sphere', size: 66, anchor: 'crown', pos: [30, -90, 20], color: 0xc62828 },
        { shape: 'sphere', size: 58, anchor: 'crown', pos: [0, -150, 60], color: 0xc62828 },
    ...
    { id: 'disney-princess/the-archer', label: 'The Archer (wild curls, bow)', rig: 'humanoid',
      ...
      accessories: [
        { shape: 'sphere', size: 34, anchor: 'crown', pos: [-40, 10, 0], color: 0xc1440e },
        { shape: 'sphere', size: 30, anchor: 'crown', pos: [40, 20, -10], color: 0xc1440e },
        { shape: 'sphere', size: 32, anchor: 'crown', pos: [0, 40, -20], color: 0xc1440e },
        { shape: 'sphere', size: 28, anchor: 'crown', pos: [-30, -40, 40], color: 0xc1440e },
        { shape: 'sphere', size: 26, anchor: 'crown', pos: [35, -50, 45], color: 0xc1440e },
        { shape: 'sphere', size: 30, anchor: 'crown', pos: [0, -70, 55], color: 0xc1440e },
    ...
    { id: 'disney-princess/the-warrior', label: 'The Warrior (armor, dark topknot)', rig: 'humanoid',
      ...
      accessories: [
        ...
        { shape: 'sphere', size: 42, anchor: 'crown', pos: [0, 40, -60], color: 0x1c1a17 },
