...
export const AVATAR_PACK_MANIFEST: PackManifestRow[] = [
  ...
  { id: 'star-wars-ot', label: 'Star Wars: Original Trilogy', path: ['Sci-Fi', 'Star Wars', 'Original Trilogy'], count: 10,
    franchise: true, load: () => import('./star-wars-ot.js') },
  { id: 'star-wars-mandalorian', label: 'Star Wars: The Mandalorian', path: ['Sci-Fi', 'Star Wars', 'The Mandalorian'], count: 8,
  ...
  { id: 'movies-lotr', label: 'The Lord of the Rings', path: ['Pop Culture', 'Movies', 'The Lord of the Rings'], count: 8,
  ...
  { id: 'pokemon', label: 'Pokémon', path: ['Video Games', 'Pokémon'], count: 8,
    franchise: true, load: () => import('./pokemon.js') },
  { id: 'mario', label: 'Mario', path: ['Video Games', 'Mario'], count: 8,
