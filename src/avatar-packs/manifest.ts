...
export const AVATAR_PACK_MANIFEST: PackManifestRow[] = [
  ...
  { id: 'dc-batman', label: 'DC: Batman', path: ['Sci-Fi', 'DC', 'Batman'], count: 10,
    franchise: true, load: () => import('./dc-batman.js') },
  ...
  { id: 'lego', label: 'LEGO minifigures', path: ['Video Games', 'LEGO'], count: 9,
