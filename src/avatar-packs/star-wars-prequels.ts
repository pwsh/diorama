...
const pack: AvatarPackDef = {
  id: 'star-wars-prequels', version: 1, label: 'Star Wars: Prequel Trilogy',
  ...
  avatars: [
    ...
    { id: 'star-wars-prequels/obi-wan', label: 'Jedi Master (tan tunic & beard)', rig: 'humanoid',
      ...
      accessories: [
        ...
        { shape: 'cone', size: [180, 300], anchor: 'back', pos: [0, -40, 10], color: 0x5c4630 },
        ...saber('handR', 0x3fa9f5)],
    ...
    { id: 'star-wars-prequels/qui-gon', label: 'Jedi Master (poncho & long hair)', rig: 'humanoid',
      ...
      accessories: [
        ...
        { shape: 'cone', size: [200, 340], anchor: 'back', pos: [0, -20, 8], color: 0x9a978c },
    ...
    { id: 'star-wars-prequels/count-dooku', label: 'Sith Lord (aristocratic, cloaked)', rig: 'humanoid',
      ...
      accessories: [
        ...
        { shape: 'cone', size: [200, 620], anchor: 'back', pos: [0, -120, 10], color: 0x4a2c22 },
    ...
    { id: 'star-wars-prequels/general-grievous', label: 'Cyborg General (four-armed)', rig: 'humanoid',
      ...
      posture: { pitch: 0.12 },
      accessories: [
        { shape: 'cone', size: [190, 520], anchor: 'back', pos: [0, -100, 10], color: 0x111112 },
