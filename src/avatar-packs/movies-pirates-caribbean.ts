...
const pack: AvatarPackDef = {
  id: 'movies-pirates-caribbean', version: 1, label: 'Pirates of the Caribbean',
  ...
  avatars: [
    ...
    { id: 'movies-pirates-caribbean/elizabeth', label: 'Pirate captain (Eastern-style black leathers)', rig: 'humanoid',
      ...
      accessories: [
        ...
        { shape: 'cone', size: [80, 240], anchor: 'back', pos: [0, -100, 12], color: 0x2a2420 }, // coat drape
    ...
    { id: 'movies-pirates-caribbean/davyjones', label: 'Cursed sea captain (tentacle beard, claw)', rig: 'humanoid',
      ...
      accessories: [
        ...
        { shape: 'cone', size: [90, 260], anchor: 'back', pos: [0, -100, 14], color: 0x3a4650 }, // coat-tail
      ],
    ...
    { id: 'movies-pirates-caribbean/tiadalma', label: 'Voodoo seer (shell jewelry, dreadlocks)', rig: 'humanoid',
      ...
      accessories: [
        ...
        { shape: 'cone', size: [85, 250], anchor: 'back', pos: [0, -100, 12], color: 0x4a3c2c }, // overcoat drape
