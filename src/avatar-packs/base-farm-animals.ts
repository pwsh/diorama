...
const pack: AvatarPackDef = {
  id: 'base-farm-animals', version: 1, label: 'Farm Animals',
  ...
  avatars: [
    ...
    { id: 'cow', label: '🐄 Cow (Holstein)', rig: 'quadruped', pet: true,
      quadruped: { sk: 1.6, bodyLen: 864, bodyW: 260, bodyH: 252, legLen: 0.85, neckLen: 90, headR: 130, ears: 'round', tail: 'down', tailLen: 1.0, tailTipColor: 0x2b2320, snout: 1.0, coat: 0xf3efe6, belly: 0xf3efe6, earColor: 0xf3efe6, snoutColor: 0x2b2320 },
      accessories: [
    ...
    { id: 'pig', label: '🐷 Pig', rig: 'quadruped', pet: true,
      quadruped: { sk: 1.2, bodyLen: 736, bodyW: 280, bodyH: 276, legLen: 0.65, neckLen: 15, headR: 120, ears: 'round', tail: 'curl', tailLen: 0.5, snout: 0.9, coat: 0xf0b8bc, belly: 0xf5cdd0, earColor: 0xecabb0, snoutColor: 0xe89aa0 },
      accessories: [
    ...
    { id: 'horse', label: '🐴 Horse (bay)', rig: 'quadruped', pet: true,
      quadruped: { sk: 1.5, bodyLen: 800, bodyW: 170, bodyH: 228, legLen: 1.4, neckLen: 220, headR: 118, ears: 'pointy', tail: 'down', tailLen: 1.7, tailTipColor: 0x1c130e, snout: 1.3, coat: 0x8a5a34, belly: 0x8a5a34, earColor: 0x8a5a34, snoutColor: 0x2a1c14, pawColor: 0x241812 },
      accessories: [
    ...
    { id: 'sheep', label: '🐑 Sheep', rig: 'quadruped', pet: true,
      quadruped: { sk: 1.25, bodyLen: 640, bodyW: 270, bodyH: 372, legLen: 0.55, neckLen: 30, headR: 95, ears: 'round', tail: 'down', tailLen: 0.3, snout: 0.75, coat: 0xf2ece0, belly: 0xf2ece0, earColor: 0x1c1c1c, snoutColor: 0x1c1c1c, pawColor: 0x1c1c1c },
      accessories: [
    ...
    { id: 'goat', label: '🐐 Goat', rig: 'quadruped', pet: true,
      quadruped: { sk: 1.15, bodyLen: 672, bodyW: 180, bodyH: 216, legLen: 1.1, neckLen: 110, headR: 105, ears: 'round', tail: 'down', tailLen: 0.3, snout: 0.85, coat: 0xc2a06a, belly: 0xe8d9bd, earColor: 0xc2a06a, snoutColor: 0x2b2320 },
      accessories: [
    ...
    { id: 'donkey', label: '🫏 Donkey', rig: 'quadruped', pet: true,
      quadruped: { sk: 1.35, bodyLen: 704, bodyW: 160, bodyH: 216, legLen: 1.15, neckLen: 150, headR: 120, ears: 'long', tail: 'tuft', tailLen: 0.9, tailTipColor: 0x2a2118, snout: 1.15, coat: 0xa39784, belly: 0xd8cdb8, earColor: 0xa39784, snoutColor: 0x362e24 },
      accessories: [
